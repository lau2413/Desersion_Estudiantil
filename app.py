...
if submit:
    try:
        # Crear DataFrame con los datos exactamente como en entrenamiento
        datos_raw = {
            # Variables numéricas
            ...
            # Variables categóricas (SIN crear dummies manualmente)
        ...
        # Crear DataFrame
        X_new = pd.DataFrame(datos_raw)
        
        # CLAVE: Asegurar que las columnas categóricas sean strings y las numéricas sean float
        ...
        st.write("Tipos de datos:", X_new.dtypes.to_dict())
        st.write("Forma del DataFrame:", X_new.shape)
        st.write("Primeras filas:", X_new.head())
